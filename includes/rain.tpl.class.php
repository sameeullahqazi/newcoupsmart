...
class RainTPL{
	...
	protected function check_template( $tpl_name ){
		...
		if( !isset($this->tpl['checked']) ){
			...
			$this->tpl['tpl_filename']          = $root_dir . "/" . $tpl_dir . $tpl_basename . '.' . self::$tpl_ext;	// template filename
			...
			// error_log("check_template_update: " . self::$check_template_update . ", tpl_dir: " . $tpl_dir . ", tpl_basedir: " . $tpl_basedir . ", tpl_ext: " . self::$tpl_ext. ", tpl['tpl_filename']: " . $this->tpl['tpl_filename'] . ", file exists: " . file_exists( $this->tpl['tpl_filename']) );
