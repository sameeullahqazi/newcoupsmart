...
class Emogrifier {
    ...
    public function emogrify() {
        ...
        $css .= $this->css; //JAKE CHANGE TO SOURCE:
        //I made this change because in the case that we want a company's CSS to overwrite our own,
        //we want to add these rules to the end of the CSS file rather than have them at the top.
        //If you want to change this back, change line 136 to the follow
        //$css = $this -> css;
        //remove line 144
